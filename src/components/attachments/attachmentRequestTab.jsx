...
const AttachmentRequestTab = () => {
    ...
    const codeSnippet = `curl -G https://api.protocol.chat/v1/attachments \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.attachments.<span className="text-purple-300">list</span>()
                        </div>
                    </div>}
...
export default AttachmentRequestTab
