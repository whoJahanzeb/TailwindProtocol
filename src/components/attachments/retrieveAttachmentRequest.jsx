...
const RetrieveAttachmentRequest = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/attachments/Nc6yKKMpcxiiFxp6 \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.attachments.<span className="text-purple-300">get</span>(<span
                            className="text-emerald-300">"Nc6yKKMpcxiiFxp6"</span>)
                        </div>
                    </div>}
...
export default RetrieveAttachmentRequest
