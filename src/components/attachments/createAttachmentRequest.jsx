...
const CreateAttachmentRequest = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/attachments \\
                ...
                <div>
                    ...
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            ...
                            className="text-purple-300">create</span>(file)
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.attachments.<span className="text-purple-300">create</span>(file = file)
                        </div>
                    </div>}
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            ...
                            <div><span className="text-emerald-300">"file"</span> => file
                            </div>
                            ]);
                        </div>
                    </div>}
