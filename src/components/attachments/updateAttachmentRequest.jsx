...
const UpdateAttachmentRequest = () => {
    ...
    const codeSnippet = `curl -X PUT https://api.protocol.chat/v1/attachments/Nc6yKKMpcxiiFxp6 \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    {activeTab === 1 && <div className="tab_panel">
                        ...
                        <div>
                            -d filename=<span
                            className="text-emerald-300">"Invoice_room_service__Plaza_Hotel_updated.pdf"</span>
                        </div>
                    </div>}
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            ...
                            className="text-emerald-300">client.attachments</span>. <span
                        ...
                        <div>
                            ...
                            <span className="text-emerald-300">'Invoice_room_service__Plaza_Hotel_updated.pdf'</span>
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.attachments.<span className="text-purple-300">update</span>(<span
                            className="text-emerald-300">"Nc6yKKMpcxiiFxp6"</span>, <div>
                            filename= <span
                            className="text-emerald-300">"Invoice_room_service__Plaza_Hotel_updated.pdf"</span>)
                        </div>
                        </div>
                    ...
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            $client<span className="text-blue-300">-></span> attachments<span
                            ...
                            <div>
                                <div>
                                    <span
                                        className="text-emerald-300"> 'filename' => 'Invoice_room_service__Plaza_Hotel_updated.pdf'</span>
                                </div>
                            </div>
                            ]
                            );
...
export default UpdateAttachmentRequest
