...
const RetrieveGroupRequest = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/groups/L7cGNIBKZiNJ6wqF \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.groups.<span className="text-purple-300">get</span>(<span
                            className="text-emerald-300">"L7cGNIBKZiNJ6wqF"</span>)
                        </div>
                    </div>}
...
export default RetrieveGroupRequest
