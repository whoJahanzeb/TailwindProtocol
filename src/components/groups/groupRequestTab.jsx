...
const GroupRequestTab = () => {
    ...
    const codeSnippet = `curl -G https://api.protocol.chat/v1/groups \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.groups.<span className="text-purple-300">list</span>()
                        </div>
                    </div>}
...
export default GroupRequestTab
