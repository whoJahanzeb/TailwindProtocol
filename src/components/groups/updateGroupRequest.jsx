...
const UpdateGroupRequest = () => {
    ...
    const codeSnippet = `curl -X PUT https://api.protocol.chat/v1/groups/L7cGNIBKZiNJ6wqF \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            description : <span className="text-emerald-300">"The finest in New York."</span>
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.groups.<span className="text-purple-300">update</span>(<span
                            className="text-emerald-300">"L7cGNIBKZiNJ6wqF"</span>, <div>
                            description= <span
                            className="text-emerald-300">"The finest in New York."</span>)
                        </div>
                        </div>
