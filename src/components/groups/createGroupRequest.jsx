...
const CreateGroupRequest = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/groups \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    {activeTab === 1 && <div className="tab_panel">
                        ...
                        <div>
                            -d name= <span className="text-emerald-300">"Plaza Hotel"</span> \
                        </div>
                    </div>}
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            ...
                            <div>
                                name: <span className="text-emerald-300">"Plaza Hotel"</span>
                            </div>
                        })
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.groups.<span className="text-purple-300">create</span>(
                            <div>
                                name= <span className="text-emerald-300">"=Plaza Hotel"</span>
                            </div>
                            )
                    ...
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            ...
                            <div><span className="text-emerald-300">"name"</span> => <span
                                className="text-emerald-300">"Plaza Hotel"</span></div>
                            ]);
                        </div>
                    </div>}
                </div>
