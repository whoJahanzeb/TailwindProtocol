...
const RetrieveRequestTab = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/contacts/WAz8eIbvDR60rouK \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.contacts.<span className="text-purple-300">get</span>(<span
                            className="text-emerald-300">"WAz8eIbvDR60rouK"</span>)
                        </div>
                    </div>}
...
export default RetrieveRequestTab
