...
const UpdateRequestTab = () => {
    ...
    const codeSnippet = `curl -X PUT https://api.protocol.chat/v1/contacts/WAz8eIbvDR60rouK \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    {activeTab === 1 && <div className="tab_panel">
                        ...
                        <div>
                            -d display_name=<span className="text-emerald-300">"UncleFrank"</span>
                        </div>
                    </div>}
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            display_name: <span className="text-emerald-300">'UncleFrank'</span>
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.contacts.<span className="text-purple-300">update</span>(<span
                            className="text-emerald-300">"WAz8eIbvDR60rouK"</span>, display_name:<span
                            className="text-emerald-300">'UncleFrank'</span>)
                        </div>
                    </div>}
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            ...
                            className="text-emerald-300">"WAz8eIbvDR60rouK"</span>,[<span
                            className="text-emerald-300">"display_name"</span><span
                            className="text-sky-300">=></span><span className="text-emerald-300">"UncleFrank"</span>]);
                        </div>
                    </div>}
                </div>
                <div>
