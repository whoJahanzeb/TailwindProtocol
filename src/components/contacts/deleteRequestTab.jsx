...
const DeleteRequestTab = () => {
    ...
    const codeSnippet = `curl -X DELETE https://api.protocol.chat/v1/contacts/WAz8eIbvDR60rouK \\
...
$client->contacts->delete('WAz8eIbvDR60rouK');`
    ...
    return (<div className={mode ? "bg-zinc-800 rounded-3xl text-sm" : "bg-black rounded-3xl text-sm"}>
        ...
        <div className="tab_content flex justify-between">
            <div>
                ...
                {activeTab === 3 && <div className="tab_panel">
                    ...
                    <div>
                        client.contacts.<span className="text-purple-300">delete</span>(<span
                        className="text-emerald-300">"WAz8eIbvDR60rouK"</span>
                    </div>
                </div>}
...
export default DeleteRequestTab
