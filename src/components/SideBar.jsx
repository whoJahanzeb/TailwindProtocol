...
const SideBar = () => {
    ...
    return (<>
        <nav
            className={mode ? "lg:flex hidden flex-col h-screen xl:w-60 bg-zinc-900 fixed" : "lg:flex hidden flex-col h-screen xl:w-60 overflow-y-auto fixed"}>
            <div
                className={mode ? "flex-1 border-r border-gray-700 px-6 py-4" : "flex-1 border-r border-gray-200 px-6 py-4"}>
                <div className="flex">
                    <div>
                ...
                <div className="my-8">
                    <div className="my-2 font-semibold text-sm"><span id="guides">Guides</span></div>
                    <div className={mode ? "border-l border-gray-700" : ""}>
                        <div className="py-1">
                            <NavLink to="/"
                                     className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}>Introduction</NavLink>
                        </div>

                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/quickstart">Quickstart</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/sdks">SDKs</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/authentication">Authentication</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/pagination">Pagination</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/errors">Errors</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/webhooks">WebHooks</NavLink></div>
                    </div>
                    <div className="my-2 font-semibold text-sm"><span>Resources</span></div>
                    <div className={mode ? "border-l border-gray-700" : ""}>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                        ...
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/conversations">Conversations</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/messages">Messages</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/groups">Groups</NavLink></div>
                        <div className="py-1"><NavLink
                            className={mode ? ({isActive}) => isActive ? "text-sm bg-zinc-700 py-2 ml-3 px-2 rounded" : "ml-3 text-sm text-zinc-500" : "ml-3 text-md text-zinc-800"}
                            to="/attachments">Attachments</NavLink></div>
                    </div>
                </div>
            </div>
        </nav>
