...
const DeleteMessageTab = () => {
    ...
    const codeSnippet = `ccurl -X DELETE https://api.protocol.chat/v1/messages/SIuAFUNKdSYHZF2w \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.messages.<span className="text-purple-300">delete</span>(<span
                            className="text-emerald-300">"SIuAFUNKdSYHZF2w"</span>
                        </div>
                    </div>}
...
export default DeleteMessageTab
