...
const SendMessageRequest = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/messages \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    {activeTab === 1 && <div className="tab_panel">
                        ...
                        <div>
                            -d 'conversation_id'= <span className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span> \
                        </div>
                        <div>
                            -d 'message'= <span className="text-emerald-300">""You’re what the French call ‘les incompetents.’""</span> \
                        </div>
                    </div>}
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            ...
                            className="text-purple-300">send</span>()
                        </div>
                        <div>
                            conversation_id: <span className="text-emerald-300">'xgQQXg3hrtjh7AvZ'</span>,
                        </div>
                        <div>
                            message: <span className="text-emerald-300">''You’re what the French call ‘les incompetents.’''</span>,
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.messages.<span className="text-purple-300">send</span>(
                            <div>
                                conversation_id= <span className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span>
                            </div>
                            <div>
                    ...
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            ...
                            className="text-blue-300">-></span> <span className="text-purple-300">send</span>([
                            <div><span className="text-emerald-300">"conversation_id"</span> => <span
                                className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span></div>
                            <div><span className="text-emerald-300">"message"</span> => <span
                                className="text-emerald-300">"'You’re what the French call ‘les incompetents.’'"</span></div>
                            ]);
                        </div>
                    </div>}
                </div>
