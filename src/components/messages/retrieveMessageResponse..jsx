                ...
                <div>
                    <div className="tab_panel">
                        ...
                        <div>
                            ...
                            className="text-emerald-300">""https://assets.protocol.chat/avatars/kevin.jpg",",</span>
                        </div>
                        <div>
                        ...
                        <div>
                            <div>
                                ...
                                className="text-emerald-300">""I’m traveling with my dad. He’s at a meeting. I hate meetings.","</span>
                            </div>
                            <div>
                                <span className="text-sky-300">"reactions"</span>: <span
                                className="text-emerald-300">[]</span>
                            </div>
                            <div>
                                <span className="text-sky-300">"attachments"</span>: <span
                                className="text-emerald-300">[]</span>
                            </div>
                            <div>
...
export default RetrieveMessageResponse
