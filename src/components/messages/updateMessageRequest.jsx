...
const UpdateMessageRequest = () => {
    ...
    const codeSnippet = `curl -X PUT https://api.protocol.chat/v1/messages/SIuAFUNKdSYHZF2w \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    {activeTab === 1 && <div className="tab_panel">
                        ...
                        <div>
                            -d reactions[red_angry_face][ ]=<span
                            className="text-emerald-300">"KateMcCallister"</span>
                        </div>
                    </div>}
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            ...
                            red_angry_face<span className="text-emerald-300">["red_angry_face"]</span>
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.messages.<span className="text-purple-300">update</span>(<span
                            className="text-emerald-300">"SIuAFUNKdSYHZF2w"</span>, <div>
                            reactions= <span
                            className="text-emerald-300">"red_angry_face" : [ "KateMcCallister" ] </span>)
                        </div>
                        </div>
                    </div>}
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            ...
                            className="text-emerald-300">"SIuAFUNKdSYHZF2w"</span>
                            [
                            <div><span className="text-emerald-300">"reactions"</span> =>
                                <div>
                                    <span
                                        className="text-emerald-300">"red_angry_face"=>[ "KateMcCallister" ]</span>
                                </div>
