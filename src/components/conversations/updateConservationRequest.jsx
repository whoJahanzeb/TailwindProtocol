...
const RetrieveConservationRequest = () => {
    ...
    const codeSnippet = `curl -X PUT https://api.protocol.chat/v1/conversations/xgQQXg3hrtjh7AvZ \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    {activeTab === 1 && <div className="tab_panel">
                        ...
                        <div>
                            -d <span className="text-emerald-300">"is_muted"</span> =true
                        </div>
                    </div>}
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            ...
                            className="text-emerald-300">client.conservations</span>. <span
                            className="text-purple-300">update</span>(<span
                            className="text-emerald-300">'xgQQXg3hrtjh7AvZ'</span>)
                        </div>
                        <div>
                            is_muted : <span className="text-emerald-300">true</span>
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.conservations.<span className="text-purple-300">update</span>(<span
                            className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span>, is_muted = <span
                            className="text-emerald-300">true</span>)
                        </div>
                    </div>}
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            $client<span className="text-blue-300">-></span> conservations<span
                            className="text-blue-300">-></span> <span className="text-purple-300">update</span>(<span
                            className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span>
                            [
                            <div><span className="text-emerald-300">"is_muted"</span> => <span
                                className="text-emerald-300">true</span></div>
                            ]
                            );
                        </div>
                    </div>}
...
export default RetrieveConservationRequest
