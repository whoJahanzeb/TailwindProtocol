...
const DeleteConservationsTab = () => {
    ...
    const codeSnippet = `curl -X DELETE https://api.protocol.chat/v1/conversations/xgQQXg3hrtjh7AvZ \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.conservations.<span className="text-purple-300">delete</span>(<span
                            className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span>
                        </div>
                    </div>}
...
export default DeleteConservationsTab
