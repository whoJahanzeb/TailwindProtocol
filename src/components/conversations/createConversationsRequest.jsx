...
const CreateConversationsRequest = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/conversations \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    {activeTab === 1 && <div className="tab_panel">
                        ...
                        <div>
                            -d <span className="text-emerald-300">'contact_id'="WAz8eIbvDR60rouK"</span> \
                        </div>
                    </div>}
                    {activeTab === 2 && <div className="tab_panel">
                        ...
                        <div>
                            contact_id: <span className="text-emerald-300">'WAz8eIbvDR60rouK'</span>,
                        </div>
                    </div>}
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.conservations.<span className="text-purple-300">create</span>(contact_id= <span
                    ...
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            ...
                            <div><span className="text-emerald-300">"contact_id"</span> => <span
                                className="text-emerald-300">"WAz8eIbvDR60rouK"</span></div>
                            ]);
                        </div>
                    </div>}
                </div>
...
export default CreateConversationsRequest
