...
const RetrieveConservationRequest = () => {
    ...
    const codeSnippet = `curl https://api.protocol.chat/v1/conversations/xgQQXg3hrtjh7AvZ \\
            ...
            <div className="tab_content flex justify-between">
                <div>
                    ...
                    {activeTab === 3 && <div className="tab_panel">
                        ...
                        <div>
                            client.conservations.<span className="text-purple-300">get</span>(<span
                            className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span>)
                        </div>
                    </div>}
                    {activeTab === 4 && <div className="tab_panel">
                        ...
                        <div className="py-4">
                            ...
                            className="text-blue-300">-></span> <span className="text-purple-300">get</span>(<span
                            className="text-emerald-300">"xgQQXg3hrtjh7AvZ"</span>);
                        </div>
                    </div>}
                </div>
